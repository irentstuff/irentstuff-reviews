...
urlpatterns = [
    ...
    path('reviews/item/<int:item_id>/', GetReviewsForItem.as_view(), name='get-reviews-for-item'),
    ...
    path('reviews/user/<str:user_id>/', GetReviewsForUser.as_view(), name='get-reviews-for-user'),
    path('reviews/item/<int:item_id>/rating/', GetItemRating.as_view(), name='get-item-rating'),
