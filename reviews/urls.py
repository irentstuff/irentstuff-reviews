...
urlpatterns = [
    ...
    path('reviews/item/<uuid:item_id>/', GetReviewsForItem.as_view(), name='get-reviews-for-item'),
    ...
    path('reviews/user/<uuid:user_id>/', GetReviewsForUser.as_view(), name='get-reviews-for-user'),
    path('reviews/item/<uuid:item_id>/rating/', GetItemRating.as_view(), name='get-item-rating'),
